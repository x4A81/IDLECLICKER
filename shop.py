...
class Shop:
    ...
    def setup_upgrades(self):
        globals.entities.append(Upgrade(1, 10, 0, 100, "Plastic Stools", "Increase profit by 10"))
        globals.entities.append(Upgrade(2, 0, 0.02, 500, "Old Sign", "Increase tip chance by 2%"))
